...
\usepackage[none]{hyphenat} %%Prevents words from being wrapped when it reaches the side margin, through hypenation
\usepackage{makecell} %can easily adjust table headers with this package
\renewcommand\theadfont{\bfseries\sffamily}

%TODO: https://tex.stackexchange.com/questions/217587/long-url-extends-into-margin-it-breaks-at-underscore-but-too-late
